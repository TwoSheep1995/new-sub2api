...
func TestHasDisplayPricing_EmptyPricingIsFallbackEligible(t *testing.T) {
	require.False(t, hasDisplayPricing(nil))
	require.False(t, hasDisplayPricing(&ChannelModelPricing{
		BillingMode: BillingModeToken,
		Models:      []string{"gpt-5.5"},
	}))

	input := 1e-6
	require.True(t, hasDisplayPricing(&ChannelModelPricing{
		BillingMode: BillingModeToken,
		InputPrice:  &input,
	}))
	require.True(t, hasDisplayPricing(&ChannelModelPricing{
