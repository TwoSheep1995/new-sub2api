...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/TwoSheep1995/new-sub2api/main/deploy/install.sh | bash
#
...
Documentation=https://github.com/TwoSheep1995/new-sub2api
