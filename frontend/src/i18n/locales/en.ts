export default {
  ...
  modelSquare: {
    ...
    baseInputOutput: 'Input/output price',
    operationGuide: 'Usage guide',
    input: 'Input/1M',
    ...
    detail: {
      ...
      effectiveInput: 'Current input price',
      effectiveOutput: 'Current output price',
      effectiveCache: 'Current cache price',
      effectiveSingleRequest: 'Current single-request price',
      baseInput: 'Original input price',
      baseOutput: 'Original output price',
      baseCache: 'Original cache price',
      baseSingleRequest: 'Original single-request price',
      ...
      officialKeyUsage: 'Official-key models use Anthropic official API access. Use the original Claude model name shown on this page, for example claude-opus-4-6.',
  ...
  nav: {
    ...
    modelPricing: 'Model Guide & Pricing',
    ...
    modelSquareControl: 'Model Square Control',
  ...
  redeem: {
    ...
    purchaseCodeTitle: 'Buy Redeem Codes',
    purchaseCodeDesc: 'Need a code? Open the purchase page in a new window, then come back here to redeem it.',
    openPurchasePage: 'Open in new window',
  ...
  modelSquare: {
    ...
    description: 'Manually choose which derived model pricing rows are shown to users.',
    searchPlaceholder: 'Search model, platform, channel, or group...',
    allRows: 'All rows',
    ...
    display: 'Display',
    sortOrder: 'Sort',
    summary: '{enabled}/{total} shown',
    empty: 'No model pricing rows found',
    saved: 'Model square display settings saved',
  },
    // Dashboard
    dashboard: {
  ...
  payment: {
    ...
    rechargeRatePreview: 'Current rate: 1 CNY = {usd} CNY balance',
