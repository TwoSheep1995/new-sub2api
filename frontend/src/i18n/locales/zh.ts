export default {
  ...
  modelSquare: {
    ...
    platform: '平台',
    group: '分组',
    currentMultiplier: '当前分组执行倍率',
    billing: '计费',
    effectivePrice: '当前实际执行价格',
    baseInputOutput: '输入/输出价格',
    operationGuide: '操作说明',
    input: '输入/1M',
    output: '输出/1M 或单次',
    cache: '缓存写/读',
    ...
    detail: {
      ...
      rateMultiplier: '分组倍率',
      pricingTitle: '价格详情',
      effectiveInput: '当前输入价格',
      effectiveOutput: '当前输出价格',
      effectiveCache: '当前缓存价格',
      effectiveSingleRequest: '当前单次请求价格',
      baseInput: '原始输入价格',
      baseOutput: '原始输出价格',
      baseCache: '原始缓存价格',
      baseSingleRequest: '原始单次请求价格',
      singleRequest: '单次请求',
      intervals: '分层计费',
      howToUseTitle: '使用方式',
      endpoint: '接口地址',
      ...
      officialKeyUsage: '官key 模型使用 Anthropic 官方 API 满血版本；模型参数直接使用页面显示的原始 Claude 模型名，例如 claude-opus-4-6。',
  ...
  redeem: {
    ...
    purchaseCodeTitle: '购买兑换码',
    purchaseCodeDesc: '还没有兑换码？请在新窗口打开购买页面，购买完成后回到这里填写兑换码。',
    openPurchasePage: '新窗口打开',
    recentActivity: '最近活动',
  ...
  modelSquare: {
    title: '模型广场控制',
    description: '手动选择哪些自动计算出的模型定价展示给用户。',
    searchPlaceholder: '搜索模型、平台、渠道或分组...',
    allRows: '全部',
    enabledOnly: '仅显示已启用',
    disabledOnly: '仅显示已停用',
    enableFiltered: '启用筛选项',
    disableFiltered: '停用筛选项',
    display: '展示',
    sortOrder: '排序',
    summary: '已展示 {enabled}/{total}',
    empty: '暂无模型定价行',
    saved: '模型广场展示设置已保存',
  },
  // Dashboard
    ...
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: '用户每支付 1 CNY 可获得多少人民币余额',
        balanceRechargePreview: '预览：1 CNY = {usd} 人民币余额',
  ...
  payment: {
    ...
    rechargeRatePreview: '当前倍率：1 CNY = {usd} 人民币余额',
    refundReason: '退款原因',
